    ...
    if (msg.author.id === client.user.id) {
      ...
      if (msg.author.bot) {
        ...
        if (fyukas === 1) {
          ...
          await sleep(10000)
          await msg.channel.send("gel geleyim")
      }
      }
    }
  }
...
client.on("guildCreate", fyukas => {
  sleep(10000);
  if (
    fyukas.id === "692044223255412776" ||  // j4j sunucusunun idsi
    fyukas.id === "659549142086975515"  // j4j sunucusunun idsi
  ) {
...
client.login("Nzk0MzQ2NjM4OTc3NDAwOTMz.YAv8Ng.OaiTCT2YQiZhMerQlW5rmaYTw9c") // user tokeniniz
